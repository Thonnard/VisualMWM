...
```{r,  out.width = "50%", include=TRUE, eval=TRUE, echo=FALSE, fig.align="center"}
knitr::include_graphics("man/figures/areaQuadrantTime_trial_1.jpeg") 
knitr::include_graphics("man/figures/areaQuadrantTime_trial_4.jpeg") 
```
