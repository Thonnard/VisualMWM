...
VisualMWM also provides functions to display behaviour in static graphs. Next example shows two area plots of time spent per quadrant. Here we can clearly see that during the fourth trial of reversal, compared to the first trial, relatively more time is spent in the target quadrant.
